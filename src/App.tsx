...
const HomePage = ({ isDarkMode }) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div style={{
            ...
            <p style={{ color: isDarkMode ? '#d1d5db' : '#64748b', lineHeight: '1.6' }}>
                Your one-stop solution for financial calculations. Navigate through our tools using the sidebar to calculate mortgage repayments, affordability, and student loan repayments.
            </p>
            <div style={{
                display: 'grid',
                ...
                <div style={{
                    ...
                    <h4 style={{ color: isDarkMode ? '#f9fafb' : '#1f2937', marginBottom: '0.5rem' }}>Mortgages</h4>
                    <p style={{ color: isDarkMode ? '#d1d5db' : '#6b7280', fontSize: '0.9rem' }}>
                ...
                <div style={{
                    ...
                    <h4 style={{ color: isDarkMode ? '#f9fafb' : '#1f2937', marginBottom: '0.5rem' }}>Student Loans</h4>
                    <p style={{ color: isDarkMode ? '#d1d5db' : '#6b7280', fontSize: '0.9rem' }}>
...
const PostgraduateRepaymentPage = ({ isDarkMode }) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div style={{
            ...
            <p style={{ color: isDarkMode ? '#d1d5db' : '#64748b', lineHeight: '1.6' }}>
                Calculate your postgraduate loan repayments and understand your options.
            </p>
        </div>
    </div>
);
...
const InfoPage = ({ isDarkMode }) => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div style={{
            ...
            <p style={{ color: isDarkMode ? '#d1d5db' : '#64748b', lineHeight: '1.6' }}>
                PaySaver is your trusted companion for financial calculations. We provide accurate, easy-to-use tools 
                to help you make informed decisions about mortgages, student loans, and other financial matters.
            </p>
        </div>
    </div>
);
...
function App() {
    ...
    const navItems = [
        ...
        { type: 'nav', id: 'MortgageAffordability', label: 'Mortgage Affordability' },
        { type: 'nav', id: 'StampDuty', label: 'Stamp duty'},
        //{ type: 'nav', id: 'AdverceCredit', label: 'Adverce Credit' },
        //{ type: 'nav', id: 'CreditScores', label: 'Credit Scores' },

        { type: 'category', label: 'University Loan' },
        { type: 'nav', id: 'UndergraduateRepayment', label: 'Undergrad Repayment' },
        { type: 'nav', id: 'PostgraduateRepayment', label: 'Postgrad Repayment' },

        //{ type: 'category', label: 'loans' },
        //{ type: 'nav', id: 'CarRepayments', label: 'Car Repayments' },
        //{ type: 'nav', id: 'CarAffordability', label: 'Car Affordability' },
        //{ type: 'nav', id: 'SecureLoan', label: 'Secure Loan' },
        //{ type: 'nav', id: 'UnsecureLoan', label: 'Unsecured Loan' },
        //{ type: 'nav', id: 'BridgingLoan', label: 'Bridging Loan' },
        
        { type: 'category', label: 'About Us' },
        { type: 'nav', id: 'Info', label: 'Info' },
        //{ type: 'nav', id: 'FinancialDictionary', label: 'Financial Dictionary' },
    ];
            ...
            return (
                <button
                    ...
                    style={{
                        ...
                        outline: 'none',
                        cursor: 'pointer',
                        backgroundColor: activeNav === item.id ? '#059669' : 'transparent',
                        color: activeNav === item.id ? 'white' : (isDarkMode ? '#d1d5db' : '#4b5563'),
                        boxShadow: activeNav === item.id ? '0 1px 2px 0 rgb(0 0 0 / 0.1)' : 'none'
                    }}
                    onMouseOver={(e) => {
                ...
                >
                    <span style={{ fontWeight: '500', pointerEvents: 'none', fontSize: '0.95rem' }}>{item.label}</span>
                </button>
            );
        }
    ...
    return (
        <>
                    ...
                    >
                        <div style={{
                            ...
                            <div style={{
                                width: '12px',
                                height: '12px',
                                backgroundColor: isSunHovered ? (isDarkMode ? '#fbbf24' : '#1f2937') : 'white',
                                borderRadius: '50%',
                                position: 'absolute',
                                top: '50%',
                                left: '50%',
            ...
            {/* Left Navigation */}
            <nav className={`custom-scrollbar nav-scrollbar ${navScrolling ? 'scrolling' : ''}`} style={{
                backgroundColor: isDarkMode ? '#1f2937' : '#f3f4f6',
                padding: '1rem',
                position: 'relative',
                zIndex: 10,
            ...
            <main className={`custom-scrollbar main-scrollbar ${mainScrolling ? 'scrolling' : ''}`} style={{
                overflowY: 'auto',
                overflowX: 'hidden',
                padding: '1.5rem',
                position: 'relative',
                ...
                <div style={{
                    ...
                    padding: '1.5rem',
                    minHeight: 'calc(100vh - 70px - 4.5rem - 24px)' // Adjust for header height and main padding
                }}>
            ...
            <aside style={{
                ...
                {/* Single Centered Google AdSense */}
                <div style={{
                    backgroundColor: isDarkMode ? '#374151' : 'white',
                    borderRadius: '8px',
                    padding: '0.5rem',
